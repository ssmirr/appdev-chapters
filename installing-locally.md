...
There are some hassles involved with local installation, which is why we avoided it initially. But, it's time to add this tool to your belt; so let's do it.
...
### Simplest: railsinstaller.org
 ...
 2. At the step where it asks you to install Sublime Text, you should instead install [VSCode](https://code.visualstudio.com/). Later, you should experiment with [customizing VSCode](https://betterprogramming.pub/vs-code-extensions-for-ruby-on-rails-developers-917474e03e04){:target="_blank"}. Even later, you should try out [RubyMine](https://www.jetbrains.com/community/education/#students){:target="_blank"} and see which you like best.
